<%@ Page Language="vb" AutoEventWireup="true" CodeBehind="Scheduler.aspx.vb" Inherits="T259265.Scheduler" %>
					...
					<dx:SplitterPane Name="CalendarPane">
						...
						<ContentCollection>
							<dx:SplitterContentControl ID="SplitterContentControl1" runat="server">
								<dx:ASPxScheduler ID="schedulerControl" runat="server" ActiveViewType="Day" OnCustomJSProperties="schedulerControl_CustomJSProperties"
